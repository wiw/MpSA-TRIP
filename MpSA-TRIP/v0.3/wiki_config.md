...
**TRIP** - if you use *"Thousands Reads In Parallel"* or **MpSA** - if you are using *"Multiplex Sequence Analysis"*
...
2. *paired* - This is **true** if you have paired sequence after Illumina or another sequence system, else it's **false**
