...
# > command_to_run.sh <path_to_source_file> <path_to_experiment_dir> <path_to_output_dir> <sub_experiment_separated_by_comma_wo_spacers>
# 
# EXAMPLE:
...
SUB_EXPERIMENT=`echo $4 | sed -r "s/,/ /g"`
...
for subs in $SUB_EXPERIMENT; do
	...
	$PYTHON $TRIP -i $SOURCE -o $OUTPUT -l ${LABEL}_${subs} $options
	echo "...end pipe"
done
